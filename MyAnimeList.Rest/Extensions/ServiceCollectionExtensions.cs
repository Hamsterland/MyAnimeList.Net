...
using MyAnimeList.API.Extensions;
using MyAnimeList.API.Objects.Errors;
using MyAnimeList.Rest.API.Anime;
using MyAnimeList.Rest.API.OAuth2;
using MyAnimeList.Rest.API.User;
using Remora.Rest;
using Remora.Rest.Core;
using Remora.Rest.Extensions;
using Remora.Rest.Results;

namespace MyAnimeList.Rest.Extensions;
    ...
    )
    {
        ...
        var clientBuilder = services
            ...
            .ConfigureHttpClient((services, client) =>
            {
                ...
                var name = assemblyName.Name ?? "MyAnimeList.Rest";
