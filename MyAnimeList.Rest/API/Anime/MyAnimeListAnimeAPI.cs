...
using MyAnimeList.Rest.Extensions.Internal;
using Remora.Rest;
using Remora.Rest.Core;
using Remora.Results;

namespace MyAnimeList.Rest.API.Anime;

/// <inheritdoc cref="MyAnimeList.API.Abstractions.API.Rest.IMyAnimeListAnimeAPI" /> 
