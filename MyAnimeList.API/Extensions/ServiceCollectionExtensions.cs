...
using MyAnimeList.API.Json.Converters.Internal;
using MyAnimeList.API.Objects.Anime;
using MyAnimeList.API.Objects.Errors;
using MyAnimeList.API.Objects.Favourites;
using MyAnimeList.API.Objects.Genres;
using MyAnimeList.API.Objects.Images;
using MyAnimeList.API.Objects.Movies;
using MyAnimeList.API.Objects.OAuth2;
using MyAnimeList.API.Objects.Pagination;
using MyAnimeList.API.Objects.Recommendations;
using MyAnimeList.API.Objects.Relations;
using MyAnimeList.API.Objects.Statistics;
using MyAnimeList.API.Objects.Titles;
using MyAnimeList.API.Objects.User;
using Remora.Rest.Extensions;
using Remora.Rest.Json;
using Remora.Rest.Json.Policies;

namespace MyAnimeList.API.Extensions;
